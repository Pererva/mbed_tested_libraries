...
Adafruit_ILI9341::Adafruit_ILI9341(PinName MOSI, PinName MISO, PinName SCLK, PinName DC, PinName CS, PinName RST) : Adafruit_GFX(ILI9341_TFTWIDTH,ILI9341_TFTHEIGHT) {
    _pins.rst = RST;
    _pins.cs = CS;
    _pins.dc = DC;
    _pins.miso = MISO;
